function walking_plan_data = Quad_planWalkingZMP(obj, x0, footstep_plan)
...
settings = Quad_QPLocomotionPlanSettings.fromQuadrupedFootstepPlan(footstep_plan, obj, x0);
...
walking_plan_data = Quad_QPLocomotionPlanCPPWrapper(settings);
