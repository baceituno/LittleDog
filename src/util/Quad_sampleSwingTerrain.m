function terrain_pts = Quad_sampleSwingTerrain(Quadruped, step1, step2, contact_width, options)
...
% @param contact_width the effective width of the foot, from Quadruped.contactVolume()
...
z = Quadruped.getTerrainHeight(xy);
z = reshape(z, size(R));
