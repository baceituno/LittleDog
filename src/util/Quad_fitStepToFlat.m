function step = Quad_fitStepToTerrain(quadruped, step)
...
[closest_terrain_pos(3,:), normal] = quadruped.getTerrainHeight(step.pos(1:3,:));
...
ground_pos(:,:) = fitPoseToNormal(ground_pos, [0;0;1]);
