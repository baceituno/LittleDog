function [contact_length, contact_width] = Quad_contactVolume(quadruped, swing1, swing2)
...
foot_body = quadruped.getBody(quadruped.getFrame(swing1.frame_id).body_ind);
